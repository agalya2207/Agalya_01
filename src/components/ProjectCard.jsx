...
const ProjectCard = ({ project, featured = false }) => {
  return (
    <article className="bg-[#0b0f19] rounded-[24px] overflow-hidden border border-[#1e293b] flex flex-col shadow-xl hover:shadow-[0_0_40px_-10px_rgba(139,92,246,0.15)] hover:border-[#8b5cf6]/40 transition-all duration-300 w-full group">
      ...
      <div className="p-8 lg:p-10 flex flex-col flex-grow">
        ...
        <div className="grid grid-cols-2 gap-4 mt-auto">
          ...
          <a href={project.live} className="flex justify-center items-center h-[52px] bg-[#8b5cf6] hover:bg-[#7c3aed] text-white text-[15px] font-semibold rounded-xl transition-colors shadow-lg shadow-purple-500/25">
